...
local function onPaint()
    if(fonts == nil) then
        fonts =
        {
            regular = render.create_font("Verdana", 20, 2, e_font_flags.ANTIALIAS, e_font_flags.DROPSHADOW);
            bold = render.create_font("Verdana Bold", 20, 2, e_font_flags.ANTIALIAS, e_font_flags.DROPSHADOW);
        }
    end
